...
fn mk_builtin_table() -> Vec<Builtin> {
    ...
    builtins.extend([
        ...
        mk_builtin("db_compact", Q(0), Q(0), vec![], true),
    ]);
    ...
    builtins.extend([
        mk_builtin(
            ...
            Q(1),
            Q(3),
            vec![Typed(TYPE_OBJ), Typed(TYPE_MAP), Typed(TYPE_LIST)],
            true,
        ),
        mk_builtin("flyslots", Q(1), Q(1), vec![Typed(TYPE_FLYWEIGHT)], true),
        mk_builtin("flycontents", Q(1), Q(1), vec![Typed(TYPE_FLYWEIGHT)], true),
        mk_builtin(
            "flyslotset",
            Q(3),
            Q(3),
