...
# Startup script for web-ssl deployment
...
DIRS="moor-data moor-ipc moor-config moor-local-share moor-telnet-host-data moor-web-host-data moor-curl-worker-data letsencrypt certbot-webroot"
for dir in $DIRS; do
