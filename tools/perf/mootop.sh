...
BPFTRACE_MAX_MAP_KEYS=${BPFTRACE_MAX_MAP_KEYS:-${BPFTRACE_MAP_KEYS_MAX:-65536}}
BPFTRACE_MAX_STRLEN=${BPFTRACE_MAX_STRLEN:-${BPFTRACE_STRLEN:-128}}
...
BPFTRACE_MAP_KEYS_MAX="${BPFTRACE_MAX_MAP_KEYS}" \
    BPFTRACE_MAX_MAP_KEYS="${BPFTRACE_MAX_MAP_KEYS}" \
    BPFTRACE_STRLEN="${BPFTRACE_MAX_STRLEN}" \
