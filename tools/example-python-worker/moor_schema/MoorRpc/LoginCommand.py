...
def AddClientToken(builder, clientToken):
    return LoginCommandAddClientToken(builder, clientToken)
def LoginCommandAddHandlerObject(builder, handlerObject): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(handlerObject), 0)
def AddHandlerObject(builder, handlerObject):
    return LoginCommandAddHandlerObject(builder, handlerObject)
def LoginCommandAddConnectArgs(builder, connectArgs): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(connectArgs), 0)
def AddConnectArgs(builder, connectArgs):
    return LoginCommandAddConnectArgs(builder, connectArgs)
def LoginCommandStartConnectArgsVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def StartConnectArgsVector(builder, numElems):
