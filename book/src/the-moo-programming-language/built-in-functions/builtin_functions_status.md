...
| [`db_compact`](server.md#db_compact)                         | &check;  |                                                                          |
...
| [`schedule_at`](server.md#schedule_at)             | Run a verb once at a Unix time as a fresh background task; returns a schedule id                                                                                                  | mooR extension                  |
| [`schedule_every`](server.md#schedule_every)       | Run a verb every N seconds, each firing a fresh background task; returns a schedule id                                                                                            | mooR extension                  |
| [`schedule_stop`](server.md#schedule_stop)         | Cancel a schedule; returns false (never raises) for a stale id                                                                                                                    | mooR extension                  |
| [`schedule_valid`](server.md#schedule_valid)       | Whether a schedule id will fire again                                                                                                                                             | mooR extension                  |
| [`schedule_info`](server.md#schedule_info)         | Map describing a schedule and its run history                                                                                                                                     | mooR extension                  |
| [`schedules`](server.md#schedules)                 | Live schedule ids visible to the caller, optionally by owner                                                                                                                      | mooR extension                  |
| [`schedules_for`](server.md#schedules_for)         | Live schedule ids targeting a given object                                                                                                                                        | mooR extension                  |
