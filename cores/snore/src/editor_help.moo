object EDITOR_HELP [
  ...
  property subst (owner: HACKER, flags: "rc") = {
    ...
    "Global regex substitution scans the original line from left to right. It does not search inserted text. After an empty match, the search advances one character; an empty match at the end is replaced once.",
