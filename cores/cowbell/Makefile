...
.PHONY: rebuild test runtime-headless runtime-headless-src clean output
...
$(HEADLESS_SRC_STAMP): $(wildcard src/*.moo src/*/*.moo tests/headless/*.moo)
