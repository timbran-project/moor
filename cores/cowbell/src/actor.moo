object ACTOR
  ...
  property pronouns (owner: ARCH_WIZARD, flags: "rc") = <#28, .is_plural = true, .verb_be = "are", .verb_have = "have", .display = "they/them", .ps = "they", .pq = "theirs", .pp = "their", .po = "them", .pr = "themselves">;
