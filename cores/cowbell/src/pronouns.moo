object PRONOUNS
  ...
  property he_him (owner: HACKER, flags: "r") = <SCHEDULED_TASK, .is_plural = false, .verb_be = "is", .verb_have = "has", .display = "he/him", .ps = "he", .po = "him", .pp = "his", .pq = "his", .pr = "himself">;
  property it_its (owner: HACKER, flags: "r") = <SCHEDULED_TASK, .is_plural = false, .verb_be = "is", .verb_have = "has", .display = "it/its", .ps = "it", .po = "it", .pp = "its", .pq = "its", .pr = "itself">;
  property she_her (owner: HACKER, flags: "r") = <SCHEDULED_TASK, .is_plural = false, .verb_be = "is", .verb_have = "has", .display = "she/her", .ps = "she", .po = "her", .pp = "her", .pq = "hers", .pr = "herself">;
  property spivak (owner: HACKER, flags: "r") = <SCHEDULED_TASK, .is_plural = false, .verb_be = "is", .verb_have = "has", .display = "e/em", .ps = "e", .po = "em", .pp = "eir", .pq = "eirs", .pr = "emself">;
  property they_them (owner: HACKER, flags: "r") = <SCHEDULED_TASK, .is_plural = true, .verb_be = "are", .verb_have = "have", .display = "they/them", .ps = "they", .po = "them", .pp = "their", .pq = "theirs", .pr = "themselves">;
