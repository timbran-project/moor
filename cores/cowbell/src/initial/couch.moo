object COUCH
  ...
  property henri_disturbed_reaction (owner: HACKER, flags: "r") = <REACTION, .enabled = true, .when = <RULE, .name = 'henri_sitting, .body = {{'is_sitting, 'This, HENRI}, {'not_is, 'This, 'Actor, HENRI}}, .variables = {'This, 'Actor}, .head = 'henri_sitting>, .trigger = 'on_sit, .effects = {{'trigger, HENRI, 'on_couch_intruder}}, .fired_at = 0>;
