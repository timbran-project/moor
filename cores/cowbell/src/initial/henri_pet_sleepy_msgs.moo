object HENRI_PET_SLEEPY_MSGS
  ...
  override entries = {
    ...
    {<SUB, .type = 'actor, .capitalize = true>, " closes ", <SUB, .type = 'pos_adj>, " eyes and pretends to enjoy it, though you can tell ", <SUB, .type = 'subject>, " ", <SUB, .type = 'verb_be>, " just too tired to protest properly."},
