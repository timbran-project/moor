object FIRST_AREA_PASSAGES
  ...
  property "tuple_019a734f-0a9c-7100-8bfc-113dba46e3a0" (owner: ARCH_WIZARD, flags: "r") = {
    FIRST_ROOM,
    #0001DB-9A6FCA8482,
    <#37, .side_a_room = FIRST_ROOM, .side_b_room = #0001DB-9A6FCA8482, .side_a_label = "south", .side_b_label = "north", .side_a_aliases = {"south", "s"}, .side_b_aliases = {"north", "n"}, .side_a_description = "To the south, the warm glow of a reading room beckons", .side_b_description = "", .side_a_ambient = true, .side_b_ambient = true, .is_open = true>
  };
  property "tuple_019a734f-0aa1-73d1-bb1b-e5295c91f35d" (owner: ARCH_WIZARD, flags: "r") = {
    FIRST_ROOM,
    #00022F-9A6FCA8482,
    <#37, .side_a_room = FIRST_ROOM, .side_b_room = #00022F-9A6FCA8482, .side_a_label = "north", .side_b_label = "south", .side_a_aliases = {"north", "n"}, .side_b_aliases = {"south", "s"}, .side_a_description = "To the north, a hallway leads deeper into the hotel", .side_b_description = "", .side_a_ambient = true, .side_b_ambient = true, .is_open = true>
  };
  property "tuple_019a734f-0aa2-7f60-b3f2-8f066156db03" (owner: ARCH_WIZARD, flags: "r") = {
    FIRST_ROOM,
    SECOND_ROOM,
    <#37, .side_a_room = FIRST_ROOM, .side_b_room = SECOND_ROOM, .side_a_label = "east", .side_b_label = "west", .side_a_aliases = {"east", "e"}, .side_b_aliases = {"west", "w"}, .side_a_description = "To the east, the hotel's main entrance awaits", .side_b_description = "A corridor back west.", .side_a_ambient = true, .side_b_ambient = true, .is_open = true>
  };
